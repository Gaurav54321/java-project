pipeline{
  ...
  stages {
    ...
    stage ("Running on Centos") {
      ...
      steps {
        sh "wget http://gauravrawat24032.mylabserver.com/rectangles/all/${env.BRANCH_NAME}/rectangle_${env.BUILD_NUMBER}.jar"
    ...
    stage ("Test on Debian") {
      ...
      steps {
        sh "wget http://gauravrawat24032.mylabserver.com/rectangles/all/${env.BRANCH_NAME}/rectangle_${env.BUILD_NUMBER}.jar"
        sh "java -jar rectangle_${env.BUILD_NUMBER}.jar 8 9"
      }
    }
